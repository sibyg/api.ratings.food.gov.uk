package uk.gov.food.ratings.api.data;
...
/**
 * Stubbing all required data to support templating of source code
 */
public class Stub {
    ...
    public List<Region> regions = Stream.of(eastRegion, northRegion, southRegion, westRegion).collect(Collectors.toList());
    public List<LocalAuthority> localAuthorities = Stream.of(northLocalAuthorityA,
    ...
    public List<Establishment> establishments = Stream.of(northAEstablishment, northBEstablishment,
